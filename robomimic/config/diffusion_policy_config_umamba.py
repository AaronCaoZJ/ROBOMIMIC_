...
class DiffusionPolicyUMambaConfig(BaseConfig):
    ALGO_NAME = "diffusion_policy_umamba"
    ...
    def algo_config(self):
        ...
        # UMamba parameters
        self.algo.umamba.enabled = True
        self.algo.umamba.diffusion_step_embed_dim = 256
        self.algo.umamba.down_dims = [256,512,1024]
        self.algo.umamba.kernel_size = 5
        self.algo.umamba.n_groups = 8
